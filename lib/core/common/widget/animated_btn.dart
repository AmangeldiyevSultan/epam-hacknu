...
import 'package:flutter_epam_kazakh/core/common/widget/ctm_text.dart';
import 'package:flutter_epam_kazakh/core/common/widget/custom_btn.dart';
...
class _AnimatedCustomButtonState extends State<AnimatedCustomButton> {
  ...
  void initState() {
    super.initState();
    _topGradient = ColorTween(begin: buttonDisabledGradient, end: greenButtonGradient)
        .animate(CurvedAnimation(parent: widget.controller, curve: Curves.decelerate));
    _bottomGradient = ColorTween(begin: buttonDisabledGradient2, end: greenButtonGradient2)
        .animate(CurvedAnimation(parent: widget.controller, curve: Curves.decelerate));
  }
